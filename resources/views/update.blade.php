...
<body>
    <div class="container-fluid">
        <div class="row">
            <div class="col">
                <form action="{{route('user.editUser',$user->id)}}" method="post">
                    @csrf
                    @method('PUT')
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="phone" name="phone" value="{{$user->phone}}" placeholder="7048152****">
                        @error('phone')
                            <p class="text-danger">{{$message}}</p>
                        @enderror
                    </div>
                    ...
                    <div class="form-check">
                        <input class="form-check-input" type="radio" name="gender" value="male" {{$user->gender == 'male'? 'checked':''}} id="flexRadioDefault1">
                      ...
                      <div class="form-check">
                        <input class="form-check-input" type="radio" name="gender" value="other" {{$user->gender == 'other'? 'checked':''}} id="flexRadioDefault3" >
